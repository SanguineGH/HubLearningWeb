    ...
    public partial class BulletinTutor : System.Web.UI.Page
    {
        ...
        private void BindDataToRepeater()
        {
            ...
            using (MySqlConnection connection = new MySqlConnection(connectionString))
            {
                ...
                string query = "SELECT b.rid, u.uid, u.name, u.pfp, b.looking, b.strand, b.availability, b.location, u.contact FROM bulletin b JOIN users u ON b.uid = u.uid WHERE b.looking = 'Tutor' AND b.visibility = ''";
